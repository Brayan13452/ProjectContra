    ...
    if(password.length()>=8)
    {
        ...
        //Pattern eight = Pattern.compile (".{8}");
          ...
          if (hasLetter.find() && hasDigit.find()) {
              hasSpecial.find();
              Component f = null;
              JOptionPane.showMessageDialog(f, "Contrasena Valida", "Alert", JOptionPane.WARNING_MESSAGE);
          }
    }
    else {
         
         Component f = null;
              JOptionPane.showMessageDialog(f, "Contrasena invalida", "Alert", JOptionPane.WARNING_MESSAGE);
      }
